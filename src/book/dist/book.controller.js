...
var BookController = /** @class */ (function () {
    ...
    BookController.prototype.getAllBook = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.book.getAllBook()];
    ...
    BookController.prototype.createBook = function (bodyBook) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.book.saveBook(bodyBook)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    BookController.prototype["delete"] = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.book.deleteBook(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ], BookController.prototype, "createBook");
    __decorate([
        common_1.Delete(':id'),

...
var genre_1 = require("./genre/genre");
var user_1 = require("./user/user");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var seed, genreServer, userServer, app;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, core_1.NestFactory.createApplicationContext(app_module_1.AppModule)];
                case 1:
                    seed = _a.sent();
                    return [4 /*yield*/, seed.select(genre_module_1.GenreModule).get(genre_1.Genre)];
                case 2:
                    genreServer = _a.sent();
                    return [4 /*yield*/, seed.select(user_module_1.UserModule).get(user_1.User)];
                case 3:
                    userServer = _a.sent();
                    // init all genres in db
                    return [4 /*yield*/, genreServer.create()];
                case 4:
                    // init all genres in db
                    _a.sent();
                    return [4 /*yield*/, userServer.create()];
                case 5:
                    _a.sent();
